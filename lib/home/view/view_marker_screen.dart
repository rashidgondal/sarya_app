...
class _ViewMarkerScreenState extends State<ViewMarkerScreen>
  ...
  void initState() {
    ...
    _tabControllerMain = TabController(length: list.length, vsync: this);
    super.initState();
              ...
              child: Container(
                child: Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        _navigationService.navigateTo(tripCompletedRoute,
                            arguments: {"id": widget.map['id'], "day": "2"});
                      },
                      child: Container(
                        height: 30,
                        width: 60,
                        ...
                        : Positioned(
                            child: Container(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemCount:
                                      place_information!.list_of_images.length,
