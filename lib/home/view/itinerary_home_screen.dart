        ...
        children: [
          Column(
            ...
            children: [
              ...
              SizedBox(
                  height: 125,
                  child: BlocBuilder<CreatedItineraryCubits,
                      CreatedItineraryStates>(builder: (context, state) {
              ...
              child: InkWell(
                onTap: () {
                  _navigationService.navigateTo(destinationRout,
                      arguments: {"country": features, "boolList": boolList});
                },
                child: Container(
                  height: 46.0,
                  width: 200.0,
