...
class SoldItineraryDetail extends StatefulWidget {
  ...
  const SoldItineraryDetail({Key? key, required this.soldAllResult}) : super(key: key);
...
class _SoldItineraryDetailState extends State<SoldItineraryDetail> {
  ...
  @override
  void initState() {
    context.read<SoldItineraryByIDCubits>().getSoldItineraryByID(itineraryID: '${widget.soldAllResult.sId}');
    super.initState();
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("${widget.soldAllResult.title}", style: TextStyle(fontSize: 13.0, fontWeight: FontWeight.w500 ,color: AppColor.headingColor),),
                              ...
                              const SizedBox(height: 5.0,),
                              Text("Total Purchases: ${widget.soldAllResult.totalPurchases}", style: TextStyle(fontSize: 10.0, fontWeight: FontWeight.w500 ,color: AppColor.subtitleColor),),
                              const SizedBox(height: 5.0,),
                              ...
                              Container(
                                  ...
                                  child: Center(
                                    child:  Padding(
                                      ...
                                      child: Text("\$ ${widget.soldAllResult.totalRevenue}", style: TextStyle(fontSize: 9.0, fontWeight: FontWeight.w500 ,color: AppColor.lightIndigo),),
                                    ),
                                  )),
                                  ...
                                  return Padding(padding: const EdgeInsets.only(right: 30.0, left: 30, top: 10),
                                    child: Container(
                                        ...
                                        child:Column(
                                          ...
                                          children: [
                                            Text("${list[index].purchaseTime??''}", style: TextStyle(fontSize: 13.0, fontWeight: FontWeight.w500 ,color: AppColor.headingColor),),
