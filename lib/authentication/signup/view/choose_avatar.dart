...
class _ChooseAvatarState extends State<ChooseAvatar> {
          ...
          body: Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index){
                  return covertImage(size: size, index: index, imageUrl: '${widget.map['url']}${widget.map['listOfColor'][index]}.${widget.map['format']}');
                })
  ...
  Widget covertImage({required Size size, required int index, required imageUrl}){
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border:  selectedPic == index? Border.all(color: AppColor.lightIndigo, width: 3): Border.all(color: AppColor.colorGrey, width: 1)),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
