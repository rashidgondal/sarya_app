    ...
    return Container(
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(
            elevation: 0,
            title: const Text("Contact me", style: TextStyle(fontSize: 17.0, color: AppColor.colorLiteBlack5),),
                ...
                child:Padding(
                  ...
                  child: Row(
                    ...
                    children: const[
                      ...
                      Text("Who can contact you directly with chats, maps, etc?", style: TextStyle(fontSize: 14, color: AppColor.headingColor2),),
