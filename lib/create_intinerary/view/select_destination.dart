  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      bottomNavigationBar: Container(
        ...
        child: Center(
          child: InkWell(
            onTap: tempCountryList.isEmpty
                ? null
                : () async {
                    Map map = await sharedPrefs.getUser();
                    String userName = map['userName'];
                    print("userName.........$userName");
                    CreateIntineraryRequest createIntineraryRequest =
                        CreateIntineraryRequest(
                            destination: tempCountryList,
                            live: false,
                            step: 1,
                            userName: userName);
                    context.read<CreateIntineraryCubits>().createIntinerary(
                        createIntineraryRequest: createIntineraryRequest,
                                ...
                                child: CheckboxListTile(
                                  ...
                                  onChanged: (bool? value) {
                                    try {
                                      ...
                                      if (value == true) {
                                        tempCountryList.add(features[index]
                                            .properties!['ADMIN']);
                                        boolList[index] = true;
                                        ...
                                        tempCountryList.remove(features[index]
                                            .properties!['ADMIN']);
