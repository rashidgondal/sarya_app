  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: BlocBuilder<CreateIntineraryCubits, CreateIntineraryStates>(
              builder: (context, state) {
                bool loading = false;

                if (state is CreateIntineraryInitial) {
                  loading = false;
                }

                if (state is CreateIntineraryLoading) {
                  loading = true;
                }

                if (state is CreateIntineraryLoaded) {
                  loading = false;
                }
