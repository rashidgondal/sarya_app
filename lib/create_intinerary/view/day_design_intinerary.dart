  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SafeArea(child:
              BlocBuilder<DayUpdateIntineraryCubits, DayUpdateIntineraryStates>(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(10),
                                                  border: Border.all(color:selected_flag == index? AppColor.lightIndigo: AppColor.borderColor2,width: 2.0,)
                                            ),
                                            child: Column(
                                              mainAxisAlignment:
                                ...
                                return InkWell(
                                    onTap: () {
                                      showDialog(
                                        ...
                                        list_of_days[selected_index].transportation =
                                            value;
                                        setState(() {});
                                      });
                                    },
                                ...
                                return InkWell(
                                    onTap: () {
                                      showDialog(
                                        ...
                                        list_of_days[selected_index].activities =
                                            value;
