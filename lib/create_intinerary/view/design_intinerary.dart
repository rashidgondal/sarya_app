    ...
    return Container(
      ...
      child: SafeArea(
        ...
        builder: (context, state) {
          ...
          if (state is UpdateIntineraryLoading) {
            loading = true;
          }

          if (state is UpdateIntineraryLoaded) {
            loading = false;
          }
                            ...
                            builder: (context, state) {
                              ...
                              return InkWell(
                                  onTap: () {
                                    showDialog(
                                        context: context,
                                        builder: (BuildContext context) =>  SelectTripType(tripList:list ,boolList: listOfBool,)).then((value){
                                          if(value != null){
                                            print("value.........$value");
                                            tripType = value;
                                          }
                              ...
                              return   InkWell(
                                  onTap: (){
                                    _navigationService.navigateTo(checkListRoute,
                                        arguments:{"checklist":listOfCheckList, "listOfBool":listOfBool})!.then((value) {
