...
class SummaryScreen extends StatefulWidget {
  ...
  final Map map;
  const SummaryScreen({Key? key, required this.routeName, required this.map})
      : super(key: key);
...
class _SummaryScreenState extends State<SummaryScreen> {
  ...
  List listIncluded = [
    {"title": "Checklist", "icon": "checklist_icon"},
    {"title": "Airport", "icon": "airplane_icon"},
    {"title": "Transport", "icon": "transport_icoon"},
    {"title": "Accommodation", "icon": "accomadation"},
    {"title": "Activities", "icon": "activityy_Icon"},
    {"title": "Breakfast", "icon": "lunch_icon"},
    {"title": "Lunch", "icon": "lunch_icon"},
    {"title": "Dinner", "icon": "lunch_icon"},
    {"title": "Shopping", "icon": "market_icon"},
    {"title": "Restaurant", "icon": "coffee_icon"}
  ];
                      ...
                      ? Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                String id = widget.map['id'];
                                SummaryUpdateIntineraryRequest summary =
                                    SummaryUpdateIntineraryRequest(
                                        live: true, step: 4);
                                context
                                    .read<SummaryUpdateIntineraryCubits>()
                                    .summaryUpdateIntineraryPage(
                                        summaryUpdateIntineraryRequest: summary,
                      ...
                      : widget.routeName == start
                          ? Center(
                              ...
                              onTap: () {
                                if (widget.map['type'] == 'active') {
                                  ...
                                  context
                                      .read<StartItineraryStateCubits>()
                          ...
                          : widget.routeName == purchase
                              ? Center(
                                  child: InkWell(
                                  onTap: () {
                                    req.PurchaseItineraryRequest request =
                                        req.PurchaseItineraryRequest(
                                            itinerary: req.Itinerary(
                                                sId: widget.map["id"],
                                                userName: userName));
                                    context
                                        .read<PurchaseItineraryByIDCubits>()
                                        .purchaseItinerary(
                                            request: request,
                                            navigationService:
                                                _navigationService);
              ...
              body: SingleChildScrollView(
                  ...
                  child: Column(
                            ...
                            : destination.isEmpty
                                ...
                                : ListView.separated(
                                    ...
                                    itemBuilder:
                                      ...
                                      var image_index = Flags.listOfFlag
                                          .indexWhere((element) =>
                                              element ==
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            title: Text.rich(
                              ...
                              TextSpan(
                                text:
                                    'Trip to ${destination == null ? "" : destination![0]} ',
                                style: TextStyle(
                                    fontSize: 13.0,
                                    color: AppColor.lightIndigo,
                                    fontWeight: FontWeight.w500),
                    ...
                    child: ClipRRect(
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: Text.rich(
                            ...
                            TextSpan(
                              text:
                                  '${"${byIDResult.tripType == null ? "" : byIDResult.tripType![0]}"}',
                              style: TextStyle(
                                  fontSize: 13.0,
                                  color: AppColor.headingColor2,
                                  fontWeight: FontWeight.w500),
                      ...
                      Padding(
                          padding:
                              const EdgeInsets.only(left: 20.0, right: 27.0),
                          child: Wrap(
                            spacing: 20,
                            runSpacing: 20,
                            children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          List<String> preSelectedCheckList =
                                              byIDResult.checklist ?? [];

                                          print(
                                              "preSelectedCheckList.....${preSelectedCheckList.length}");
                                    ...
                                    InkWell(
                                      onTap: () {
                                        ...
                                        List<String> linkPath = List<
                                            ...
                                            nameOfImage.length,
                                            (index) =>
                                                '${ApiRoutes.picBaseURL}${nameOfImage[index]}');
