class StatusItineraryResponse {
  String? msg;
  List<DraftResult>? result;
  int? totalCount;

  StatusItineraryResponse({this.msg, this.result, this.totalCount});

  StatusItineraryResponse.fromJson(Map<String, dynamic> json) {
    msg = json['msg'];
    if (json['result'] != null) {
      result = <DraftResult>[];
      json['result'].forEach((v) {
        result!.add(DraftResult.fromJson(v));
      });
    }
...
class DraftResult {
  ...
  DraftResult.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
